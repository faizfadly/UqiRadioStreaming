package id.fdev.example.uqifm.service;
...
import id.fdev.example.uqifm.MainActivity;
...
public class StreamService extends Service implements
    ...
    public static final String BROADCAST_BUFFER = "id.fdev.example.uqifm.broadcastbuffer";
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (intent != null && intent.getExtras() != null)
            URL_STREAM = intent.getStringExtra("url");
    ...
    private void initNotification() {
        ...
        builder = new NotificationCompat.Builder(this)
                ...
                .setContentTitle("Official Radio")
                .setContentText("UQI-FM 107.1");
